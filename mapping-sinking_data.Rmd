...
```{r}
sinking_data_dd_41 <-sinking_data_dd %>%
  filter(year == 1941,
...
sinking_data_dd_jan_sep_44 <-sinking_data_dd %>%
  filter(year == 1944) %>% 
...
leaflet() %>%
  ...
  addCircleMarkers(data = sinking_data_dd_41,
                   lng = ~lon,
                   lat = ~lat,
                   color = ~pal(sinking_agent),
                   radius = 3,
  ...
  addCircleMarkers(data = sinking_data_dd_43,
                   ...
                   popup = ~paste(name, type, sinking_agent, date, sep = " "), 
                   group = "3. 1943") %>%
  addCircleMarkers(data = sinking_data_dd_jan_sep_44,
                   lng = ~lon,
                   lat = ~lat,
                   color = ~pal(sinking_agent),
                   radius = 3,
                   popup = ~paste(name, type, sinking_agent, date, sep = " "), 
                   group = "4. Jan-Sep, 1944") %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("1. 1941","2. 1942","3. 1943","4. Jan-Sep, 1944","5. Oct-Dec, 1944", 
                      "6. Jan-Apr, 1945", "7. May-Aug, 1945"))%>% 
